...
export const lesson09Graph: GraphDefinition = {
  ...
  nodes: [
    ...
    { id: "plan", label: "计划/执行", icon: "▦", phase: "tool" },
  ...
  edges: [
    ...
    { id: "dispatch-plan", source: "dispatch", target: "plan" },
    { id: "plan-loop", source: "plan", target: "loop" },
    { id: "tc-ogate", source: "tc", target: "ogate", label: "否" },
    { id: "ogate-redact", source: "ogate", target: "redact", label: "拦截" },
    { id: "ogate-done", source: "ogate", target: "done", label: "通过" },
  ],
};
